...
all.techies=[{key:'techies',k:'techies',name:'爆破起飞',en:'Blast Off',type:'active',description:'选择一个单位，造成等同于炸弹人当前生命值一半（向上取整）的透甲伤害；炸弹人受到同等数值的伤害，但生命最低维持1点。',descriptionEn:"Choose a unit: deal piercing damage equal to half of Techies' current health (rounded up); Techies takes the same amount but keeps at least 1 health.",cooldown:2,icon:'assets/dota2/techies_blast_off.png'}];
all.snapfire=[{key:'snapfire',k:'snapfire',name:'快速攻击',en:"Lil' Shredder",type:'active',description:'对正对的1个敌方单位快速攻击3次，每次造成1点透甲伤害（无视护甲）。第5回合起升级：改为对正对的至多3个相邻敌方单位各快速攻击3次。',descriptionEn:"Rapidly attack the opposing unit 3 times for 1 piercing damage each, ignoring armor. From round 5 it hits up to 3 opposing neighbors.",cooldown:2,icon:'assets/dota2/snapfire_lil_shredder.png'}];
all.largo=[{key:'largo',k:'largo',name:'动人之舐',en:'Catchy Lick',type:'active',description:'驱散本路所有友方单位的负面状态（沉默、缴械、眩晕、恐惧翻牌、缠绕、中毒、减攻减甲等），每净化1个单位朗戈回复1点生命，并把友方单位拉向靠近朗戈的空位。每次使用青蛙能量+1（上限5点）。',descriptionEn:'Purge every allied unit in this lane of negative effects (silence, disarm, stun, fear-flip, root, poison, negative attack/armor). Heal Largo 1 per unit cleansed, then pull allies toward the empty slots beside him. Grants +1 Frog Energy per use (cap 5).',cooldown:2,icon:'assets/dota2/largo_catchy_lick.png',counter:'frog'}];
