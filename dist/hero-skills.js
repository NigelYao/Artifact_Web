...
all.snapfire=[{key:'snapfire',k:'snapfire',name:'快速攻击',en:"Lil' Shredder",type:'active',description:'对正对的1个敌方单位快速攻击3次，每次造成1点透甲伤害（享受护甲穿透等加成）。第5回合起升级：改为对正对的至多3个相邻敌方单位各快速攻击3次。',descriptionEn:"Rapidly attack the opposing unit 3 times for 1 piercing damage each; benefits from armor penetration. Upgrades after round 5 to hit up to 3 opposing neighbors.",cooldown:2,icon:'assets/dota2/snapfire_lil_shredder.png'}];
