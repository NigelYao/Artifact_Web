...
all.monkey_king=[{key:'monkey_king',k:'monkey_king',name:'棒击蓄势',en:'Primed Strike',type:'active',description:'齐天大圣每次攻击获得1点能量，能量随回合保留。能量达到3点后可主动施放：消耗3点能量对一个单位造成4点伤害，此后召唤的猴子猴孙永久+1攻击，可叠加。',descriptionEn:'Monkey King gains 1 energy per attack, persisting across rounds. At 3+ energy he may cast: spend 3 energy to deal 4 damage to a unit; Monkey Soldiers summoned afterwards gain +1 attack permanently, stacking.',cooldown:0,counter:'charges',icon:'assets/dota2/monkey_king_boundless_strike.png'},{key:'monkey_king_spring',k:'monkey_king_spring',name:'就地腾挪',en:'Nimble Shift',type:'active',description:'将齐天大圣移至本路一个己方空位，并在其原位置召唤一个1攻击、1生命的猴子猴孙（出击两次后消散）。',descriptionEn:'Move Monkey King to an empty friendly slot in this lane and summon a 1/1 Monkey Soldier where he stood (vanishes after attacking twice).',cooldown:2,icon:'assets/dota2/monkey_king_tree_dance.png'}];
