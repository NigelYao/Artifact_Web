...
all.techies=[{key:'techies',k:'techies',name:'爆破起飞',en:'Blast Off',type:'active',description:'选择一个单位，造成等同于其当前生命值一半（向上取整）的透甲伤害；炸弹人受到同等数值的伤害，但生命最低维持1点。',descriptionEn:'Choose a unit: deal piercing damage equal to half its current health (rounded up); Techies takes the same amount of damage but always keeps at least 1 health.',cooldown:2,icon:'assets/dota2/techies_blast_off.png'}];
